...
const CopilotUI = () => {
  ...
  // ✅ REMOVED: useCustomVoiceActions() call to prevent duplicate action registration
  // All actions are now handled by useQuantumBankActions() in EnhancedCopilotPopup
